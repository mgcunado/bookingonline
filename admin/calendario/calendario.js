		...
		function muestraDiasMes(mes, ano){
			...
			capaDiasMes.children().click(function(e){
				...
				if (numDiaPulsado != ""){
                    ...
                    //script para aumentar en un día la fecha de salida cuando se clicka el de llegada
                    //se añade 1 hora más (3600000 milisegundos) al día de añadido para el elemento2 para compensar el desajuste del cambio de mes
