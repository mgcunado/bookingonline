...
<body>
    ...
    <?php if ($tarifasestandar) {
        ...
        <table class="menuprincipal" width=90% align=center>
            <tr>
                <td width=100%><a href="index.php?tarifasestandar=yes">Modificar Variables Generales</a></td>
            </tr>
        </table>

        <table class="instrucciones" width="80%" align="center">
            <tr>
                <td>Seleccione Fecha de llegada y Fecha de salida.<br />Seleccione una de las 3 opciones siguientes: Disponibilidad, Modificar Tarifas y Estancia mínima para actuar sobre las fechas seleccionadas.<br />Haga click sobre el botón <b>Enviar</b> para modificar la base de datos que verán posteriormente los usuarios en su web.</td>
            </tr>
        </table>
